  ...
  const items = await Promise.all(
    sortedPosts.map(async (blog: CollectionEntry<"blog">) => {
      ...
      return {
        ...
        content: `${content} <blockquote>This rendering was generated for the site feed and may have formatting issues. For the best experience, please visit: <a href="${postURL}">${postURL}</a></blockquote>`,
        customData: `
